...
function language_dropdown_network_settings_page() {
   ...
   if (isset($_POST['submit'])) {
      ...
      update_site_option('language_dropdown_network_entries', $languages);
      echo '<div class="updated"><p>Network settings saved.</p></div>';
   }

   $languages = get_site_option('language_dropdown_network_entries', array());
   
   wp_enqueue_media();
   wp_enqueue_script('jquery-ui-sortable');
   ?>
   <div class="wrap">
      <h1>Language Dropdown Network Settings</h1>
   ...
   <script>
      jQuery(document).ready(function($) {
         ...
         $(document).on('click', '.select-flag-image', function() {
            ...
            var imageContainer = row.find('.flag-image-container');
            var imageIdInput = row.find('.flag-image-id');
